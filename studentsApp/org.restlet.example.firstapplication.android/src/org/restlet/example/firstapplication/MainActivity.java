...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//process button Turn on Zeroconf 
        Button btn_zeroconf = (Button) findViewById(R.id.buttonZeroconf);
        btn_zeroconf.setOnClickListener(new View.OnClickListener() {        
            @Override 
            public void onClick(View view) { 
                // TODO Auto-generated method stub 
            	Intent myIntent = new Intent(view.getContext(), DnssdDiscovery.class);
